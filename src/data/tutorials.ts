...
export const tutorials: Tutorial[] = [
...

  {
    ...
    steps: [
      ...
      'Aceda a office.com e entre com a sua conta Microsoft (pode criar uma gratuitamente em outlook.com).',
    ...
    tips: [
      ...
      'A conta Microsoft é gratuita e inclui 5 GB de armazenamento no OneDrive.',
    ],
  },
  {
    id: 'criar-conta-microsoft',
    title: 'Criar uma conta Microsoft gratuita',
    category: 'word-online',
    categoryLabel: 'Word Online',
    icon: '👤',
    description: 'Para usar o Word Online, o OneDrive e o Teams gratuitamente precisa de uma conta Microsoft. É simples e rápido de criar.',
    steps: [
      'Abra o browser e aceda a account.microsoft.com.',
    ...
    tips: [
      ...
      'A conta Microsoft dá acesso ao Word Online, Excel Online, PowerPoint Online e 5 GB no OneDrive.',
  ...
  },
  {
    ...
    steps: [
      'O OneDrive está ligado à sua conta Microsoft e tem 5 GB gratuitos.',
      'Quando usa o Word Online, o documento guarda automaticamente no OneDrive.',
      'Para aceder: aceda a onedrive.live.com com a sua conta Microsoft.',
...

  {
    ...
    steps: [
      ...
      'Para aceder no browser: vá a teams.microsoft.com e entre com a sua conta Microsoft.',
    ...
    tips: [
      ...
      'O Teams é gratuito com conta Microsoft pessoal.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Quando terminar, o Teams abre e pede sessão. Introduza o email e palavra-passe da conta Microsoft.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Entre com o email e palavra-passe da conta Microsoft.',
