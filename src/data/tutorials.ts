...
export const tutorials: Tutorial[] = [
  ...
  // ── WORD ONLINE ──
  {
    ...
    icon: '🌐',
    description: 'O Word Online é a versão gratuita do Word que funciona directamente no browser, sem instalar nada. Guarda automaticamente de forma automática.',
    steps: [
      ...
      'Escreva o seu texto — é guardado automaticamente, sem precisar de fazer nada.',
    ...
    tips: [
      ...
      'O documento fica guardado no OneDrive — pode abri-lo em qualquer computador.',
      'Partilhe o documento com o formador através do link.',
    ],
  ...
  },
  {
    ...
    categoryLabel: 'Word Online',
    icon: '☁️',
    description: 'O OneDrive guarda os seus ficheiros online. Assim nunca perde o trabalho e pode aceder a partir de qualquer computador.',
    steps: [
  ...
  // ── FICHEIROS ──
  {
    ...
    icon: '📂',
    description: 'O Google Drive é outra forma de guardar ficheiros online, de forma totalmente gratuita.',
    steps: [
