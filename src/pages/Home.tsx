...
const mainFeatures = [
  {
    ...
    description: 'Tutoriais simples sobre rato, teclado, Word e como guardar e enviar ficheiros.',
    accent: true,
  },
  {
    to: '/portfolio',
    ...
    description: 'Formulário passo a passo para criar o seu portefólio e descarregá-lo em Word.',
    accent: true,
  },
  {
    to: '/verificador',
  ...
  },
  {
    ...
    icon: '📖',
    title: 'Apoio ao Word',
    description: 'Guias sobre como formatar, guardar e enviar o seu documento Word corretamente.',
    accent: false,
  },
  {
    to: '/formadores',
    ...
    description: 'Recursos, links úteis e materiais de apoio para formadores RVCC.',
    accent: false,
  },
]
